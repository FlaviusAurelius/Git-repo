...
(** **** Exercise: 2 stars, advanced, especially useful (add_comm_informal)
    ...
    Base case: Suppose n = 0, we need to show 0+m = m+0, by definition of addition
                0+m simplifies to m, so does m+0 by lemme add_0_r. Base case holds
                since 0 = 0.
    Inductive Case: Let n = S n', for some natural number n'. Assume that n'+m = m+n',
                      show S n' + m = m + S n'. 
                      By inductive hypothesis, we have S (n' + m) = m + S n'
                      By definition of addition, we can replace n'+m with m+n'
                        giving us S (m + n') = m + S n'
                      By definition of plus_n_Sm, we get m + S n' = m + S n',
                      Thus inductive case also holds. Qed.
*)
...
(** **** Exercise: 2 stars, standard, optional (eqb_refl_informal)
    ...
    Proof: 
     ...
     Proof by induction on n.
     Base Case: Suppose n = 0, we need to show that 0=?0 = true. By definition of 
                  =?, comparing 0 to 0 results in true, since 0 is 0, thus base 
                  case holds 
     Inductive Case: Let n = S n', for some natural number n', we need to show that
                      S n' =? S n' = true.
                     We know that S n' is the sucessor of n', and that by the 
                      definition of =?, when comparing n' to n', since they are
                      both n', it should evaluate to true. Then, since the sucessor 
                      S n' are the sucessor to number n', and we know that n' =? n' = true,
                      comparison of S n' =? S n' should also evaluates to true.
                     Thus the inductive case holds, for all natural number n,
                      n' =? n' evaluates to true. Qed.
*)
